<?php 
  if($this->session->userdata('USERNAME') == '') {
    echo "<script>alert('Silahkan Login Dulu !');window.location.href='".base_url()."medical/login'</script>";
  }
?>
<!DOCTYPE HTML>
<html>
...
<body>
	...
	<div class="sin-w3-agile">
		<h2>Sign In</h2>
		<form action="<?= base_url('zakat/login_exec')?>" method="post" >
			<div class="username">
				<span class="username">Username:</span>
				<input type="text" name="txtuser" class="name" placeholder="" required="">
			...
			<div class="login-w3">
					<input type="submit" name="btlogin" class="login" value="Sign In">
			</div>
			<div class="clearfix"></div>
		</form>
				<div class="back">
				...
				<div class="footer">
					<p>&copy; 2016 ADH . All Rights Reserved | Design by Ade Hermawan</a></p>
				</div>
	</div>
	</div>
	</div>
